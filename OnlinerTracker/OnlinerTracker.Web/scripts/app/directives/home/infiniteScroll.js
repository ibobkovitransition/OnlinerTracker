...
//angular.module("infiniteScroll").directive("infiniteScroll", ["$rootScope", "$window", "$timeout",
...
//				elementBottom = angular.element(elem).prop('offsetTop') + angular.element($window);
//				remaining = elementBottom - windowBottom;
